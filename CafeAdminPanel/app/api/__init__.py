...
from .endpoints.Admin.admin import router as admin_router

from .endpoints.Menu.menuCRUD import router as menuCRUD_router
from .endpoints.Menu.menu_filter import router as menu_filter_router
